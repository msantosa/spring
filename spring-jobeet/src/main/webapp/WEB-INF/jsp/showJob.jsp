...
<div id="job">
	...
	<h3>
		${trabajo.position} <small>${trabajo.type}</small>
	</h3>

	<c:if test="${not empty trabajo.logo}">
		<div class="logo">
			<a href="${trabajo.url}"> <img class="logo_compania"
				alt="${trabajo.company}" src="/uploads/logos/${trabajo.logo}">
			</a>
		</div>
	</c:if>
